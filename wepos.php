...
final class WePOS
{
    ...
    public function init_classes()
    {
        ...
        // HOTFIX: Ensure REST Manager class is loaded since composer.json isn't present
        // to re-dump the autoloader for this specific missing file.
        if (!class_exists('\WeDevs\WePOS\REST\Manager')) {
            require_once WEPOS_INCLUDES . '/REST/Manager.php';
        }
