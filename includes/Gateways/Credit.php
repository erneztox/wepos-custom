...
class Credit extends \WC_Payment_Gateway
{
    ...
    {
        $this->id = 'wepos_credit';
        $this->icon = apply_filters('wepos_credit_icon', '');
        $this->method_title = __('Crédito', 'wepos');
        $this->method_description = __('Pago con tarjeta de crédito', 'wepos');
    ...
    public function init_form_fields()
    {
        ...
        $this->form_fields = array(
            'enabled' => array(
                ...
                'label' => __('Enable credit gateway', 'wepos'),
                'type' => 'checkbox',
                'description' => '',
                'default' => 'yes',
            ),
            ...
            'description' => array(
                ...
                'default' => __('Pago con tarjeta de crédito', 'wepos'),
                'desc_tip' => true,
            )
        );
    }
    ...
    public function process_payment($order_id)
    {
        ...
        $order->update_status('completed', sprintf(
            __('Pago recibido vía Crédito. Voucher: %s', 'wepos'),
